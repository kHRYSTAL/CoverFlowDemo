...
public class ViewGroupExample extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoverFlow fancyCoverFlow = (CoverFlow) findViewById(R.id.fancyCoverFlow);
    ...
    private static class ViewGroupExampleAdapter extends CoverFlowAdapter {
        ...
        public View getCoverFlowItem(int i, View reuseableView, ViewGroup viewGroup) {
            ...
            if (reuseableView != null) {
                ...
                customViewGroup.setLayoutParams(new CoverFlow.LayoutParams(300, 600));
            }
